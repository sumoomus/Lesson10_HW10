public class DocumentNumberUtils {
    ...
    public static void processDocumentNumber(String documentNumber) {
        ...
        String formattedLetters = String.format("%s/%s/%s/%s", letters.substring(0, 3), letters.substring(3, 6), letters.charAt(6), letters.charAt(7));
        System.out.println(formattedLetters.toLowerCase());


        StringBuilder sb = new StringBuilder("Letters:");
        sb.append(letters.substring(0, 3)).append("/").append(letters.substring(3, 6)).append("/").append(letters.charAt(6)).append("/");
